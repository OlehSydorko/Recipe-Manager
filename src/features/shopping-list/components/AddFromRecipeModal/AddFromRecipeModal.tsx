...
import styles from './AddFromRecipeModal.module.scss';
            ...
            {ingredients && ingredients.length > 0 && (
                <div className={styles.scrollList}>
                    {ingredients.map((ingredient) => {
                        ...
                        return (
                            <label key={ingredient.id} className={styles.ingredientRow}>
                                <span className={styles.checkboxWrapper}>
                                    ...
                                    {isChecked && <Check size={13} className={styles.checkIcon} />}
                                </span>
