...
import { useCollectionRecipeIds, useCollections } from '@/hooks/useCollections';
...
// Collections page. Membership (adding/removing recipes) reuses CollectionModal
// as-is — it already writes a collection's full recipe list on save, so "Add
// recipe" here just opens the same edit form used from the collections grid.
export default function CollectionDetailPage({ params }: CollectionDetailPageProps) {
    ...
    const isPending = collectionsPending || recipeIdsPending || recipesPending;
        ...
        <div>
            ...
            {!isPending && collectionRecipes?.length === 0 && (
                <div className='mt-16 flex flex-col items-center gap-3 text-center'>
                    ...
                    <p className='text-body text-text-secondary'>Add recipes to get started.</p>
                </div>
            )}
